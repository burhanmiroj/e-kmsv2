...
@section('title', isset($data) ? 'Periksa Ibu Nifas' : 'Periksa Ibu Nifas' )
...
<!-- begin panel -->
<form action="{{ isset($data) ? route('admin.data-ibu.ibunifasperiksa.update', $data->id) : route('admin.data-ibu.ibunifasperiksa.store') }}" id="form" name="form" method="POST" data-parsley-validate="true">
    @csrf
    @if(isset($data))
    {{ method_field('PUT') }}
    @endif
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-1 my-auto">
                                <label for="date"><b>Tanggal Periksa</b></label>
                            </div>
                            <div class="col-md-5">
