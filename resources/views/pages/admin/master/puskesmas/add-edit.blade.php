...
@section('title', isset($data) ? 'Edit Puskesmas' : 'Create Puskesmas')
...
@section('content')
    ...
    <!-- begin panel -->
    <form
        action="{{ isset($data) ? route('admin.master-data.puskesmas.update', $data->id) : route('admin.master-data.puskesmas.store') }}"
