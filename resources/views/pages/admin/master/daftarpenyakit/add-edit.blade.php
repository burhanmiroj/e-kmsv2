...
<!-- begin panel -->
<form action="{{ isset($data) ? route('admin.master-data.daftar_penyakit.update', $data->id) : route('admin.master-data.daftar_penyakit.store') }}" id="form" name="form" method="POST" data-parsley-validate="true">
    @csrf
    @if(isset($data))
    {{ method_field('PUT') }}
    @endif
